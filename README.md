...
Run `python3 adversarial.py` — 621 checks written to falsify these claims, not
...
| file | what |
|---|---|
| `adversarial.py` | **621 falsification checks, 26 of them forgery attacks against a live prover.** Start here. |
