...
Run `python3 adversarial.py` — 638 checks written to falsify these claims, not
...
| file | what |
|---|---|
| `adversarial.py` | **638 falsification checks, 26 of them forgery attacks against a live prover.** Start here. |
